        ...
        !DisableController = 1                  ; 0 = no, 1 = yes
        ...
        !FreezeRAM  =   $1FFF|!addr             ; 1 byte of free RAM, clears on reset
...
.idle
    ...
    ..beginTeleporting
        ...
        LDA $1470|!addr                         ; \
        ORA $148F|!addr                         ; | don't allow teleporting if you're carrying something
        BNE ..dontTeleport                      ; /

        LDA $1426|!addr                         ; \  don't allow teleporting if a message box is active
        BNE ..dontTeleport                      ; /
    ...
    ..doTeleport
        ...
        ; STZ $17C0|!addr                       ; \
        ; STZ $17C1|!addr                       ; | erase all smoke sprites?
        ; STZ $17C2|!addr                       ; | (this doesn't seem to work)
        ; STZ $17C3|!addr                       ; /
...
.exitingPipe
    ...
    +   STA $13E0|!addr                         ; /
        ...
        STZ $73                                 ; \
        LDA #$01                                ; |
        STA $185C|!addr                         ; | all kinds of teleportation settings
        LDA #$02                                ; |
        STA $13F9|!addr                         ; |
        if !FreezeTimeWhenTeleporting           ; |
          LDA #$FF                              ; |
    ...
    ..nextState
        ...
        STA $7D
                                                ; \
        STZ $185C|!addr                         ; |
        STZ $13F9|!addr                         ; | all kinds of teleportation settings
        STZ $1419|!addr                         ; |
        STZ $78                                 ; |
        ;STZ $9D                                ; /
        STZ !State
